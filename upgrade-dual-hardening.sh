...
echo "[1/7] Fetching production v4 controller and staged SNI helper from ref: $PROJECT_REF"
...
echo "[3/7] Adding independent randomized probes, target diversity, and Foreign TCP metadata..."
...
echo "[4/7] Switching controller service and CLI to production v4..."
mkdir -p "$DROPIN_DIR"
cat >"$DROPIN" <<EOF
[Service]
ExecStart=
